...
|---|---|---|
| `docs/08-validation/evidence/local-root-check.txt` | Ruff, strict MyPy, 191 Python tests, ESLint, strict TypeScript, 46 frontend tests, production build, Chrome and Edge core E2E, Chrome privacy E2E, and Unicode scan PASS | `ed1d04b26f648532aa55bc85c54e1d94427399acd4fa2664cd9f7ce1b58bf4e9` |
| `docs/08-validation/evidence/public-personal-detail-scan.json` | All 568 staged public files except the report itself scanned against nine non-public personal-detail terms with zero findings | `3eb9320dfebcb53925bec349ce67f2ce609879aa7300c6b436324b404f30bffb` |
...
| `docs/10-release/RELEASE_CANDIDATE_STATUS.md` | Revision 2.2 records the authorized Azure sequence without promoting live gates | `6e86394650740d1c003d572fff16ceee6a2b349ff13e920f2491131acf3cad58` |
