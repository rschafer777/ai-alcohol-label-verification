...
|---|---|---|
| `docs/08-validation/evidence/local-root-check.txt` | Ruff, strict MyPy, 191 Python tests, ESLint, strict TypeScript, 46 frontend tests, production build, Chrome and Edge core E2E, Chrome privacy E2E, and Unicode scan PASS | `6c4fdd50dfebbbe9d8420cbd94c9430aa850d82e1c765af06d235af4fc79d346` |
| `docs/08-validation/evidence/public-personal-detail-scan.json` | All 568 staged public files except the report itself scanned against nine non-public personal-detail terms with zero findings | `7ff0b35e9754f5d359d54b120d2dfcaab509890bda1182d1287bae7dd3171cc7` |
...
| `docs/08-validation/evidence/local-product-corpus.json` | 30 of 30 cases, 456 of 456 rows, 8 of 8 mutations, zero false clean | `0d1346095ae578ed24d0bc6fc8e067d7f7f9bd1d085cc476705f0c12e09b4a1e` |
...
| `docs/08-validation/evidence/browser-privacy-matrix.json` | Complete required Chrome browser lifecycle and storage matrix PASS | `d72b9c1874fa150b7586188162e35ccba64829ce6a32d74ecfeca86b91b29494` |
...
| `docs/10-release/RELEASE_CANDIDATE_STATUS.md` | Revision 2.0 records the authorized Azure sequence without promoting live gates | `0cd53af8c2166ee64729af442779fd91b55b63d772f13646a84c2a5d76815489` |
