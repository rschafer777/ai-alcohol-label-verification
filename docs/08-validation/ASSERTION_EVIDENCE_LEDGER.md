...
|---|---|---|
| `docs/08-validation/evidence/local-root-check.txt` | Ruff, strict MyPy, 191 Python tests, ESLint, strict TypeScript, 46 frontend tests, production build, Chrome and Edge core E2E, Chrome privacy E2E, and Unicode scan PASS | `0b262e297c3d9c0d930c93d917b17fdd699b567a40c01a58a39e2a371086135c` |
| `docs/08-validation/evidence/public-personal-detail-scan.json` | All 568 staged public files except the report itself scanned against nine non-public personal-detail terms with zero findings | `785c5228ac5d1787946ec83062209d26ac9a6d34243ef0a6d8258c23e291418a` |
...
| `docs/08-validation/evidence/browser-privacy-matrix.json` | Complete required Chrome browser lifecycle and storage matrix PASS | `469d82ee62d3fa763c57b2e21439d809b683ceaee2cd5e8b81f092d6da70c0be` |
...
| `docs/10-release/RELEASE_CANDIDATE_STATUS.md` | Revision 2.0 records the authorized Azure sequence without promoting live gates | `1cc4155bdebced209f665c9f0a0e3afb81333eacf336544542c845c867c5702c` |
