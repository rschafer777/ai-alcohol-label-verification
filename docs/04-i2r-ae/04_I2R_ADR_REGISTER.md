...
| `ADR-009` | Fly.io one always-running shared-cpu-2x, 2 GiB | Render, Railway, Azure Container Apps | Current low-cost public path and readiness control; actual cost/config/performance readback blocks release |
