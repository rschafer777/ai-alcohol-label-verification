...
| 1.5 | 2026-09-05 | Classified production-scale Azure load qualification as a pre-production gate distinct from demo-UAT entry | Product-owner release direction |
...
| FR-062 | Demo-UAT entry binds local representative, 20-product timing, and 300-product browser-capacity evidence to the exact governed 4-vCPU and 8-GiB Azure revision and passes distinct difficult malt, wine, and spirits live smoke. Before a production-scale Azure performance or p95 claim, sanitized products use distinct admitted pixel hashes with disclosed beverage, panel, difficulty, and dimension distributions; 30 distinct products provide a quick operational gate and at least 100 distinct product fingerprints support p95; cold startup is separate; and rate and queue waits remain in batch wall time | INT-Q-011, BAIRD-34 |
