...
| `FR-040` | Must | `BR-015`, `BR-016`, `BR-027` | Enforce LV-I2R-002 Fly client identity, Host, Origin, secure response-header, no-store, and privacy-safe digest contracts. | `C-006`, `C-015`, deployment | PASS when direct/proxied identity, spoofed/duplicate/malformed/missing headers, identity/rate isolation, Host/Origin matrix, CSP/HSTS/anti-framing/referrer/permissions headers, and no-store behavior all pass; FAIL otherwise. | `T-040` |
